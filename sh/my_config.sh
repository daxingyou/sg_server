...
#监听端口起始值
global_server_port_start=37000
...
#服务器组外网IP
server_out_ip="192.168.1.212"

#连接mysql:sg_account(sql\config.py)
cnf_account_db_ip="139.196.41.108"
cnf_account_db_user="wsy"
cnf_account_db_pwd="Wsy1985!"
cnf_account_db_name="wai_trunk_sg_account"

#连接mysql:sg_area(sql\config.py)
cnf_area_db_ip="192.168.1.5"
cnf_area_db_user="root"
cnf_area_db_pwd="Sanguo1!"
cnf_area_db_name="nei_trunk_sg_area"
...
connect_to_account_ip="139.196.41.108;139.196.41.108"
...
gate_connect_to_cross_ip="192.168.1.5"
gate_connect_to_cross_port="37006"
...
gate_timeout_alive=259200

##################################################
#center_server
#连接transfer_server(支持多个，用';'隔开)，参考global_server_port_start
center_connect_to_transfer_ip="192.168.1.5"
center_connect_to_transfer_port="37001"

##################################################
#chat_server
#连接transfer_server(支持多个，用';'隔开)，参考global_server_port_start
chat_connect_to_transfer_ip="192.168.1.5"
chat_connect_to_transfer_port="37000"

#######################################################################
##### 其他数据库 #####
#######################################################################
#sg_statistics
ss_db_ip="139.196.41.108"
ss_db_user="wsy"
ss_db_pwd="Wsy1985!"
ss_db_name="sg_statistics"

#sg_bbs
bbs_db_ip="139.196.41.108"
bbs_db_user="wsy"
bbs_db_pwd="Wsy1985!"
bbs_db_name="sg_bbs"

#sg_up
up_db_ip="139.196.41.108"
up_db_user="wsy"
up_db_pwd="Wsy1985!"
up_db_name="sg_up"
...
#######################################################################
##### 战斗回放日志 send_combat_logs.sh #####
#######################################################################
#这里修改的话，同时也要修改server.xml中的对应字段
combat_log_dir="$main_path/nohup_run/combat_logs/"
#为空，表示不备份
combat_log_backup_dir=""
#combat_log_backup_dir="$main_path/nohup_run/combat_logs_backup/"
#发送战斗回放日志的时间间隔 秒
send_time=3
#对端信息
combat_log_dst_user="root"
combat_log_dst_passwd="iGame2015"
combat_log_dst_ip="192.168.1.5"
combat_log_dst_dir="/var/www/html/sg_game_combat_logs/"