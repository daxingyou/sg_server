...
#######################################################################
#服务器列表类型
server_list_type="INNER_EDITOR;OUTSIDE_IOS;OUTSIDE_ANDROID;OUTSIZE_IOS_BRANCH_XXX;OUTSIZE_ANDROID_BRANCH_XXX;TRUNK_TEST_ANDROID;ALL_TRUNK_EDDITER_TEST;ALL_BRANCH_EDDITER_TEST;ALL_TRUNK_IOS_TEST;ALL_TRUNK_ANDROID_TEST;OUT_BRANCH_IOS_TEST;OUT_BRANCH_ANDROID_TEST;ALL_BRANCH_IOS_TEST;ALL_BRANCH_ANDROID_TEST;TRUNK_TEST_IOS;YALI_TEST;OUT_SIDE_ANDROID_SERVER;OUT_SIDE_IOS_SERVER"
...
account_server_port_start=36100
...
#监听端口起始值
global_server_port_start=40000
...
login_connect_to_account_port="36101;36104"
db_connect_to_account_port="36102;36105"

##################################################
#gate_server
#连接cross_server(支持多个，用';'隔开)，参考global_server_port_start
gate_connect_to_cross_ip="127.0.0.1;127.0.0.1"
gate_connect_to_cross_port="40006;40007"
...
center_connect_to_transfer_port="40001;40003"

##################################################
#chat_server
#连接transfer_server(支持多个，用';'隔开)，参考global_server_port_start
chat_connect_to_transfer_ip="127.0.0.1;127.0.0.1"
chat_connect_to_transfer_port="40000;40002"
