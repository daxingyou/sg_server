...
#######################################################################
#服务器列表类型
server_list_type="OUT_BRANCH_ANDROID_JIUYOU"
...
sdk_login_url="http:\/\/47.100.130.174:8080\/branches\/20180525\/sg_sdk\/sdk_service.php"

##################################################
#account_server
#监听IP和端口起始值
account_server_listen_ip="127.0.0.1"
account_server_port_start=10000
...
#监听端口起始值
global_server_port_start=20000
...
#cdkey兑换的web地址
cdkey_url="http:\/\/47.100.130.174:8080\/branches\/20180525\/sg_cdkey\/cdkey.php"
...
login_connect_to_account_port="10001;10004"
db_connect_to_account_port="10002;10005"

##################################################
#gate_server
#连接cross_server(支持多个，用';'隔开)，参考global_server_port_start
gate_connect_to_cross_ip="127.0.0.1;127.0.0.1"
gate_connect_to_cross_port="20006;20007"
...
center_connect_to_transfer_port="20001;20003"

##################################################
#chat_server
#连接transfer_server(支持多个，用';'隔开)，参考global_server_port_start
chat_connect_to_transfer_ip="127.0.0.1;127.0.0.1"
chat_connect_to_transfer_port="20000;20002"
...
combat_log_dst_ip="139.196.41.108"
