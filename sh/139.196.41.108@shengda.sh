...
#######################################################################
#服务器列表类型
server_list_type="INNER_EDITOR;OUT_BRANCH_ANDROID_SHENGDA"
...
account_server_port_start=36300
...
#监听端口起始值
global_server_port_start=44000
...
cnf_area_db_name=$user_name"_"$version_name"_sg_area"
...
login_connect_to_account_port="36301;36304"
db_connect_to_account_port="36302;36305"

##################################################
#gate_server
#连接cross_server(支持多个，用';'隔开)，参考global_server_port_start
gate_connect_to_cross_ip="127.0.0.1;127.0.0.1"
gate_connect_to_cross_port="44006;44007"
...
center_connect_to_transfer_port="44001;44003"

##################################################
#chat_server
#连接transfer_server(支持多个，用';'隔开)，参考global_server_port_start
chat_connect_to_transfer_ip="127.0.0.1;127.0.0.1"
chat_connect_to_transfer_port="44000;44002"
