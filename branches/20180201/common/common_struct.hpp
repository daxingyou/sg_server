...
enum KICK_ROLE_REASON : uint32_t
{
    ...
    KICK_ROLE_REASON_ALIVE_TIMEOUT      = 4,    //缓存超时
    ...
    KICK_ROLE_REASON_BAN_ACCOUNT        = 11,   //封号
...
enum GAME_SERVER_TYPE : uint32_t
{
	GAME_SERVER_NONE = 0,				// 未知类型
	GAME_SERVER_STATIC = 1,				// 静态地图场景服务器
	GAME_SERVER_DYNAMIC = 2,			// 动态地图场景服务器
};
