...
public:
    ...
    static bool handle_ln_run_server_notify(const network::tcp_socket_ptr& s, const network::msg_buf_ptr& msg_buf);
	static bool handle_ln_close_server_notify(const network::tcp_socket_ptr& s, const network::msg_buf_ptr& msg_buf);
