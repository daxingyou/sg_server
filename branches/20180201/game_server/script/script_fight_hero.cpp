...
void script_fight_hero_t::c_skill_damage(script_fight_hero_t* target, int damage, unsigned int skill)
{
	...
	getOwner()->skill_damage(target->getOwner()->shared_from_this(), damage, skill);
}
...
void script_fight_hero_t::c_skill_ext_damage(script_fight_hero_t* target, int damage, unsigned int skill)
{
	...
	getOwner()->skill_ext_damage(target->getOwner()->shared_from_this(), damage, skill);
}
...
void script_fight_hero_t::c_share_damage_to(script_fight_hero_t* teammate, script_fight_hero_t* attacker, unsigned int skill, int damage)
{
	...
	if (NULL == teammate->getOwner())
	{
		log_error("teammate owner is null");
		return;
	}
	...
	getOwner()->share_damage_to(teammate->getOwner()->shared_from_this(), attacker->getOwner()->shared_from_this(), skill, damage);
}
// ·ÏÆú
// void script_fight_hero_t::c_add_buff_count(unsigned int id)
// {
// 	if (NULL == getOwner())
// 	{
// 		log_error("owner is null");
...
// 	}
// 
// 	getOwner()->m_buff_mgr.add_trigger_count(id);
// }
// 
// void script_fight_hero_t::c_sub_buff_count(unsigned int id)
// {
// 	if (NULL == getOwner())
// 	{
// 		log_error("owner is null");
...
// 	}
// 
// 	getOwner()->m_buff_mgr.sub_trigger_count(id);
// }
// 
// unsigned int script_fight_hero_t::c_get_buff_count(unsigned int id)
// {
// 	if (NULL == getOwner())
// 	{
// 		log_error("owner is null");
