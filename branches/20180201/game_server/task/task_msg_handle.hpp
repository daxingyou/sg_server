...
public:
	...
	static bool handle_cg_get_quick_task_info_request(const network::tcp_socket_ptr& s, const network::msg_buf_ptr& msg_buf);
	static bool handle_cg_complate_quick_task_request(const network::tcp_socket_ptr& s, const network::msg_buf_ptr& msg_buf);
};
