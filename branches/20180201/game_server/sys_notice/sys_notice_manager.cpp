...
bool sys_notice_manager_t::broadcast_system_msg_for_money(const uint64_t role_uid, proto::common::MONEY_TYPE type, uint32_t param, uint32_t param_id /*= 0*/)
{
	...
	{
		BROADCAST_SYS_NOTICE_SYS_CHANNEL(role_uid, proto::common::sys_notify_type_add_lifeforce, 0, param);
	}break;
	case proto::common::MONEY_TYPE_COPPER:
	{
		BROADCAST_SYS_NOTICE_SYS_CHANNEL(role_uid, proto::common::sys_notify_type_add_copper, 0, param);
	}break;
	case proto::common::MONEY_TYPE_ENERGY:
	{
		BROADCAST_SYS_NOTICE_SYS_CHANNEL(role_uid, proto::common::sys_notify_type_add_energy, 0, param);
	}break;
	case proto::common::MONEY_TYPE_SILVER:
	{
		BROADCAST_SYS_NOTICE_SYS_CHANNEL(role_uid, proto::common::sys_notify_type_add_sliver, 0, param);
	}break;
	case proto::common::MONEY_TYPE_YUANBAO:
	{
		BROADCAST_SYS_NOTICE_SYS_CHANNEL(role_uid, proto::common::sys_notify_type_add_gold, 0, param);
	}break;
	case proto::common::MONEY_TYPE_HONOR:
	{
		BROADCAST_SYS_NOTICE_SYS_CHANNEL(role_uid, proto::common::sys_notify_type_honor, 0,  param);
	}break;
	case proto::common::MONEY_TYPE_CONTRIBUTION:
	{
		BROADCAST_SYS_NOTICE_SYS_CHANNEL(role_uid, proto::common::sys_notify_type_contribution, 0, param);
	}break;
	case proto::common::MONEY_TYPE_LIFE_STONE:
	{
		BROADCAST_SYS_NOTICE_SYS_CHANNEL(role_uid, proto::common::sys_notify_type_life_stone, 0, param);
	}break;
	case proto::common::MONEY_TYPE_HEROSOUL:
	{
		BROADCAST_SYS_NOTICE_SYS_CHANNEL(role_uid, proto::common::sys_notify_type_herosoul, 0,  param);
	}break;
	case proto::common::MONEY_TYPE_PRESTIGE:
	{
		BROADCAST_SYS_NOTICE_SYS_CHANNEL(role_uid, proto::common::sys_notify_type_add_prestige, 0,  param);
	}break;
	case proto::common::MONEY_TYPE_LIVENESS:
	{
		BROADCAST_SYS_NOTICE_SYS_CHANNEL(role_uid, proto::common::sys_notify_type_liveness, 0,  param);
	}break;
	case proto::common::MONEY_TYPE_EXP:
	{
		BROADCAST_SYS_NOTICE_SYS_CHANNEL(role_uid, proto::common::sys_notify_type_add_exp, 0, param);
	}break;
	case proto::common::MONEY_TYPE_ACHIEVE_POINT:
	{
		BROADCAST_SYS_NOTICE_SYS_CHANNEL(role_uid, proto::common::sys_notify_type_add_achieve_point, 0, param);
	}break;
	case proto::common::MONEY_TYPE_VIGOUR:
	{
		BROADCAST_SYS_NOTICE_SYS_CHANNEL(role_uid, proto::common::sys_notify_type_vigour, 0, param);
	}break;
	default:
		break;
	}
