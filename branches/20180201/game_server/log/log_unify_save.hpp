#ifndef __GAME_LOG_UNIFY_SAVE_HPP__
#define __GAME_LOG_UNIFY_SAVE_HPP__
...
public:
    ...
    static void save()
    {
        ...
        proto::log::go_batch_save_logs_notify msg;
        ...
        env::server->send_msg_to_log(op_cmd::go_batch_save_logs_notify, msg);
		reset();
    }
