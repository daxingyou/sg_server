...
public:
	...
	static bool handle_cg_king_war_scene_num_request(const network::tcp_socket_ptr& s, const network::msg_buf_ptr& msg_buf);
	...
	static bool handle_cg_use_artifact_request(const network::tcp_socket_ptr& s, const network::msg_buf_ptr& msg_buf);
	static bool handle_cg_ask_king_war_result_request(const network::tcp_socket_ptr& s, const network::msg_buf_ptr& msg_buf);
};
