CREATE TABLE IF NOT EXISTS `role_exp_level_log` (
    ...
    INDEX(`source_type`),
    INDEX(`create_time`)
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8 COMMENT='角色经验等级日志';
...
CREATE TABLE IF NOT EXISTS `hero_exp_level_log` (
    ...
    INDEX(`source_type`),
    INDEX(`create_time`)
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8 COMMENT='武将经验等级日志';
...
CREATE TABLE IF NOT EXISTS `login_log` (
    ...
    INDEX(`source_type`),
    INDEX(`create_time`)
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8 COMMENT='登入登出日志';
...
CREATE TABLE IF NOT EXISTS `item_log` (
    ...
    INDEX(`source_type`),
    INDEX(`create_time`)
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8 COMMENT='道具日志';
...
CREATE TABLE IF NOT EXISTS `money_log` (
    ...
    INDEX(`source_type`),
    INDEX(`create_time`)
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8 COMMENT='钱币日志';
...
CREATE TABLE IF NOT EXISTS `hero_log` (
    ...
    INDEX(`source_type`),
    INDEX(`create_time`)
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8 COMMENT='武将日志';
...
CREATE TABLE IF NOT EXISTS `prestige_log` (
    ...
    INDEX(`source_type`),
    INDEX(`create_time`)
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8 COMMENT='声望日志';
...
CREATE TABLE IF NOT EXISTS `family_log` (
    ...
    INDEX(`source_type`),
    INDEX(`create_time`)
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8 COMMENT='家族日志';
...
CREATE TABLE IF NOT EXISTS `country_log` (
    ...
    INDEX(`source_type`),
    INDEX(`create_time`)
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8 COMMENT='国家日志';
...
CREATE TABLE IF NOT EXISTS `friend_log` (
    ...
    INDEX(`source_type`),
    INDEX(`create_time`)
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8 COMMENT='好友日志';
...
CREATE TABLE IF NOT EXISTS `mail_log` (
    ...
    INDEX(`source_type`),
    INDEX(`create_time`)
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8 COMMENT='邮件日志';
...
CREATE TABLE IF NOT EXISTS `pk_log` (
    ...
    INDEX(`source_type`),
    INDEX(`create_time`)
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8 COMMENT='PK日志';
...
CREATE TABLE IF NOT EXISTS `shop_log` (
    ...
    INDEX(`source_type`),
    INDEX(`create_time`)
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8 COMMENT='商店日志';
...
CREATE TABLE IF NOT EXISTS `random_shop_log` (
    ...
    INDEX(`source_type`),
    INDEX(`create_time`)
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8 COMMENT='随机商店日志';
...
CREATE TABLE IF NOT EXISTS `equip_log` (
    ...
    INDEX(`source_type`),
    INDEX(`create_time`)
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8 COMMENT='装备日志';
...
CREATE TABLE IF NOT EXISTS `lifeforce_log` (
    ...
    INDEX(`source_type`),
    INDEX(`create_time`)
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8 COMMENT='命力日志';
...
CREATE TABLE IF NOT EXISTS `achieve_log` (
    ...
    `add_count` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '进度改变值',
    ...
    INDEX(`source_type`),
    INDEX(`create_time`)
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8 COMMENT='成就日志';
...
CREATE TABLE IF NOT EXISTS `dungeon_log` (
    ...
    INDEX(`source_type`),
    INDEX(`create_time`)
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8 COMMENT='副本日志';
...
CREATE TABLE IF NOT EXISTS `role_buff_log` (
    ...
    INDEX(`source_type`),
    INDEX(`create_time`)
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8 COMMENT='buff日志';
...
CREATE TABLE IF NOT EXISTS `goods_log` (
    ...
    INDEX(`source_type`),
    INDEX(`create_time`)
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8 COMMENT='寄售行日志';
...
CREATE TABLE IF NOT EXISTS `trade_log` (
    ...
    INDEX(`source_type`),
    INDEX(`create_time`)
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8 COMMENT='跑商日志';
...
CREATE TABLE IF NOT EXISTS `new_guide_log` (
    ...
    INDEX(`source_type`),
    INDEX(`create_time`)
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8 COMMENT='新手引导日志';
...
CREATE TABLE IF NOT EXISTS `recharge_log` (
    ...
    INDEX(`recharge_tid`),
    INDEX(`create_date`)
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8 COMMENT='充值日志';
...
CREATE TABLE IF NOT EXISTS `expedition_log` (
    ...
    INDEX(`source_type`),
    INDEX(`create_time`)
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8 COMMENT='远征日志';
...
CREATE TABLE IF NOT EXISTS `scene_log` (
    ...
    INDEX(`source_type`),
    INDEX(`create_time`)
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8 COMMENT='场景日志';
...
CREATE TABLE IF NOT EXISTS `combat_log` (
    ...
    INDEX(`combat_type`),
    INDEX(`create_time`)
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8 COMMENT='战斗日志';
...
CREATE TABLE IF NOT EXISTS `redbag_log` (
    ...
    INDEX(`source_type`),
    INDEX(`create_time`)
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8 COMMENT='红包日志';