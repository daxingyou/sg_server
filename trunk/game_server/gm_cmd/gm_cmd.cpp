...
void gm_cmd_t::allot_gm_cmd(role_ptr p_role, std::vector<std::string>& gm_cmd_list)
{
	...
	else if (0 == strcmp(gm_cmd.c_str(), "/taskall"))
	{
		gm_cmd_opt_t::opt_finish_all_task(p_role);
	}
	...
	else if (0 == strcmp(gm_cmd.c_str(), "/test_achieve"))
	{
		gm_cmd_opt_t::opt_test_achieve(p_role);
	}
	else if (0 == strcmp(gm_cmd.c_str(), "/add_head"))
	{
		gm_cmd_opt_t::opt_add_head(p_role, gm_cmd_list);
	}
	else if (0 == strcmp(gm_cmd.c_str(), "/cur_tower"))
	{
		gm_cmd_opt_t::opt_set_cur_tower(p_role, gm_cmd_list);
	}
	else if (0 == strcmp(gm_cmd.c_str(), "/record_tower"))
	{
		gm_cmd_opt_t::opt_set_record_tower(p_role, gm_cmd_list);
	}
	else if (0 == strcmp(gm_cmd.c_str(), "/change_name"))
	{
		gm_cmd_opt_t::opt_change_name(p_role, gm_cmd_list);
	}
	else if (0 == strcmp(gm_cmd.c_str(), "/open_all_dungeon"))
	{
		gm_cmd_opt_t::opt_open_all_dungeon(p_role);
	}
	else if (0 == strcmp(gm_cmd.c_str(), "/elite_all"))
	{
		gm_cmd_opt_t::opt_finish_all_elite(p_role);
	}
	else if (0 == strcmp(gm_cmd.c_str(), "/fight_win"))
	{
		gm_cmd_opt_t::opt_fight_win(p_role);
	}
	else if (0 == strcmp(gm_cmd.c_str(), "/clearcd"))
	{
		gm_cmd_opt_t::opt_clearcd(p_role);
	}
