...
public:
	...
	static void		peek_all_data(uint64_t uid, proto::common::active_reward_data* p_data);
	...
	static bool		add_active_reward(const uint64_t role_uid, active_reward_ptr p_active_reward,bool is_load = false);
