...
#include "liandan/liandan_msg_handle.hpp"
#include "patrol_hire/patrol_hire_msg_handle.hpp"
#include "general_event/general_event_msg_handler.hpp"
#include "family_skill/family_skill_msg_handle.hpp"
#include "recharge/recharge_msg_handle.hpp"
#include "office/office_msg_handle.hpp"
...
bool gate_msg_handler_t::init_msg_handler()
{
	...
	//liandan message
	if (!liandan_msg_handle_t::init_msg_handler())
	{
		log_error("init liandan msg handler failed!");
		return false;
	}

	//patrol_hire message
	if (!patrol_hire_msg_handle_t::init_msg_handler())
	{
		log_error("init patrol_hire msg handler failed!");
		return false;
	}
	
	if (!general_event_msg_handler_t::init_gate_msg_handler())
	{
		log_error("init general_event_msg_handler msg handler failed!");
		return false;
	}

	if (!family_skill_msg_handle_t::init_msg_handler())
	{
		log_error("init family_msg_handle_t msg handler failed!");
		return false;
	}

	//recharge message
	if (!recharge_msg_handle_t::init_msg_handler())
	{
		log_error("init recharge msg handler failed!");
		return false;
	}

	//office message
	if (!office_msg_handle_t::init_msg_handler())
	{
		log_error("init office msg handler failed!");
		return false;
	}
    return true;
}
