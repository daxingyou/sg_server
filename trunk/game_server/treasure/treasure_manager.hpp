...
private:
	static int32_t get_item_index(uint32_t item_id);
	static uint32_t get_treasure_item_1();
	static uint32_t get_treasure_item_2();
	static uint32_t get_treasure_item_3();
};
