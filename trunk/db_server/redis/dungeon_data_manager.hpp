...
public:
	...
	static bool save_dungeon_times_data_to_redis(uint64_t uid, const proto::common::role_all_dungeon_times_data& data);
	static bool load_dungeon_times_data_from_redis(uint64_t uid, proto::common::role_all_dungeon_times_data* data);
};
