...
public:
	...
	static bool save_achieve_data_to_redis(uint64_t uid, const proto::common::achieve_data& data);
	static bool load_achieve_data_from_redis(uint64_t uid, proto::common::achieve_data* p_data);
};
