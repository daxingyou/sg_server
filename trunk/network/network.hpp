...
public:
    ...
    void post_close_socket(const network::tcp_socket_ptr& s, bool is_del_forced = true);

protected:
	void stop_all_listen();
	void clear_all_listen();

	void stop_all_connect();
	void clear_all_connect();
