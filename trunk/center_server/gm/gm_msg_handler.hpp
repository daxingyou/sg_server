...
public:
	...
	static bool handle_me_send_notice_request(const network::tcp_socket_ptr& s, const network::msg_buf_ptr& msg_buf);
	static bool handle_me_transport_ntf(const network::tcp_socket_ptr& s, const network::msg_buf_ptr& msg_buf);
	static bool handle_me_send_gm_msg_to_account_request(const network::tcp_socket_ptr& s, const network::msg_buf_ptr& msg_buf);
	static bool handle_me_manage_role_ntf(const network::tcp_socket_ptr& s, const network::msg_buf_ptr& msg_buf);
    static bool handle_me_reload_xml_request(const network::tcp_socket_ptr& s, const network::msg_buf_ptr& msg_buf);
public:
