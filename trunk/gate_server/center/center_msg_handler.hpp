...
public:
	...
	static bool handle_ea_kick_all_user_notify(uint16_t cmd, const network::msg_buf_ptr& msg_buf);
	...
	static bool handle_ea_send_gm_msg_to_account_request(uint16_t cmd, const network::msg_buf_ptr& msg_buf);
public:
