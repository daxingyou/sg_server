CREATE TABLE IF NOT EXISTS `arena_score_rank` (
	...
	`server_name` varchar(20) NOT NULL DEFAULT '' COMMENT '玩家所在服务名',
...
COMMENT='玩家积分排行表' ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE='utf8_general_ci';
...
COMMENT='玩家积分历史排行表' ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE='utf8_general_ci';
...
COMMENT='演武大赛表' ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE='utf8_general_ci';
...
COMMENT='演武大赛投注表' ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE='utf8_general_ci';
