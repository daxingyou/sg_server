...
{
#ifdef _PLATFORM_X64
	static const int          FormatCheckCode = 0x038DCFC9; ///< I|IIIIIIIVIiIIVVIVII
#else
	static const int          FormatCheckCode = 0x0E0E2FF9; ///< I|IIIIIIIvIiIIvvIvII
#endif
...
struct DungeonTable : public Entry
{
	...
	uint32_t                  base_id() { return t_base_id; }
