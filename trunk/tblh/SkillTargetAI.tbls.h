...
enum target_ai_type
{
	...
	target_ai_friend_max_att_atk_rate,    ///< 攻击力最高的友军
...
{
#ifdef _PLATFORM_X64
	static const int          FormatCheckCode = 0x0512FFF9; ///< I|iiiiiiiiiiiiiiii
#else
	static const int          FormatCheckCode = 0x0512FFF9; ///< I|iiiiiiiiiiiiiiii
#endif
	...
	int32_t                   friend_max_att_atk_rate;      ///< 攻击力最高的友军
};
#pragma pack()
...
inline void SkillTargetAI::fill( const SkillTargetAIBase& base )
{
	...
	t_all_target_ai_type.push_back(base.friend_max_att_atk_rate);
};
