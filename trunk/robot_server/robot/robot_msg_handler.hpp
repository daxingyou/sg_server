...
public:
	...
	//==========================================================================
	static bool handle_ec_field_boss_info_notify(robot_ptr robot, const network::msg_buf_ptr& msg_buf);
	static bool handle_gc_field_boss_attack_reply(robot_ptr robot, const network::msg_buf_ptr& msg_buf);

	//跨服战
	static bool handle_gc_arena_match_reply(robot_ptr robot, const network::msg_buf_ptr& msg_buf);

	//商城购买
	static bool handle_gc_buy_month_card_reply(robot_ptr robot, const network::msg_buf_ptr& msg_buf);
