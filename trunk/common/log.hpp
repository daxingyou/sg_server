...
public:
    ...
    void close();
	void write_log(log_level_t level, const char* file, int line, const char* func, const char* format, ...) __attribute__((format(printf, 6, 7)));
	bool is_stopped() const { return m_io_service.stopped(); }
