...
public:
	...
	virtual uint32_t get_time_unique_id(uint32_t check_time) { return 0; }

	virtual uint32_t get_time_by_unique_id(uint32_t unique_id) { return 0; }
	...
	bool in_time() const { return _inTime; }	//true 表示开启， false表示结束
...
public:
	...
	virtual uint32_t get_time_unique_id(uint32_t check_time) { return get_day_id(check_time); }

	virtual uint32_t get_time_by_unique_id(uint32_t unique_id);
...
public:
	...
	virtual uint32_t get_time_unique_id(uint32_t check_time) { return get_week_id(check_time); }
