...
void global_data_mgr_t::load_king_war_data(proto::server::global_data_type type, proto::server::global_data_king_war_data& data)
{
	redis_client_t::get_protobuf("global_server_data", "data", (uint32_t)type, data);
}

void global_data_mgr_t::save_king_war_data(proto::server::global_data_type type, const proto::server::global_data_king_war_data& data)
{
	redis_client_t::set_protobuf("global_server_data", "data", (uint32_t)type, data);
}
