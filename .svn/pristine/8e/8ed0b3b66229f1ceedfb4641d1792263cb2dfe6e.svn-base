...
bool source_type_converter_t::init_desc()
{
	...
	ret &= regist_liandan_desc();
	ret &= regist_patrol_hire_desc();
	ret &= regist_general_event_desc();
...
bool source_type_converter_t::regist_user_desc()
{
	...
	ret &= regist_desc(log_enum::source_type_role_add_exp_limit, "经验转功绩");
	ret &= regist_desc(log_enum::source_type_role_career_award, "领取成长历程奖励");
	ret &= regist_desc(log_enum::source_type_role_change_name, "改名");
	ret &= regist_desc(log_enum::source_type_role_use_item_add_title, "使用加称号道具");
	ret &= regist_desc(log_enum::source_type_role_use_item_change_plugin, "使用变身道具");
	ret &= regist_desc(log_enum::source_type_role_office_award, "逆命师每日奖励");
	ret &= regist_desc(log_enum::source_type_role_use_item_key_gift, "使用钥匙礼包");
	ret &= regist_desc(log_enum::source_type_role_handbook_award, "领取收集奖励");
	ret &= regist_desc(log_enum::source_type_role_use_item_add_activity, "使用活动次数道具");

	ret &= regist_desc(log_enum::source_type_role_logout_center_server_close, "中心服务器关闭");
	ret &= regist_desc(log_enum::source_type_role_logout_game_unreg, "被game服务器注销");
	ret &= regist_desc(log_enum::source_type_role_logout_db_close, "db服务器关闭");
...
bool source_type_converter_t::regist_hero_desc()
{
	...
	ret &= regist_desc(log_enum::source_type_hero_smelt, "武将重生");
	ret &= regist_desc(log_enum::source_type_hero_addfamous, "激活名将册");
...
bool source_type_converter_t::regist_task_desc()
{
	...
	ret &= regist_desc(log_enum::source_type_task_event_award, "任务事件奖励");
...
bool source_type_converter_t::regist_family_desc()
{
	...
	ret &= regist_desc(log_enum::source_type_family_levelup_skill, "升级家族技能");
...
bool source_type_converter_t::regist_country_desc()
{
	...
	ret &= regist_desc(log_enum::source_type_country_demise_king, "国家禅让国王");
	ret &= regist_desc(log_enum::source_type_country_king_war_state, "国家王城战状态");
	ret &= regist_desc(log_enum::source_type_country_king_war_family, "国家王城战家族产生");
	ret &= regist_desc(log_enum::source_type_country_king_war_failed, "国家王城战非正常结束");
	ret &= regist_desc(log_enum::source_type_country_king_war_end, "国家王城战结束");
	ret &= regist_desc(log_enum::source_type_country_king_war_time_end, "国家王城战开战时间到了");
	ret &= regist_desc(log_enum::source_type_country_king_war_help_add, "国家王城战助战家族添加");
	ret &= regist_desc(log_enum::source_type_country_king_war_help_del, "国家王城战助战家族删除");
...
bool source_type_converter_t::regist_friend_desc()
{
	...
	ret &= regist_desc(log_enum::source_type_friend_update_shadow, "更新化身次数");

	ret &= regist_desc(log_enum::source_type_friend_plus_friendliness, "增加亲密度");
	ret &= regist_desc(log_enum::source_type_friend_minus_friendliness, "减少亲密度");
	ret &= regist_desc(log_enum::source_type_friend_send_fp, "赠送友情点");
	ret &= regist_desc(log_enum::source_type_friend_get_fp, "领取友情点");
	ret &= regist_desc(log_enum::source_type_friend_get_relation_award, "领取羁绊奖励");
	ret &= regist_desc(log_enum::source_type_friend_send_gift, "送礼");
	ret &= regist_desc(log_enum::source_type_friend_plus_charm, "增加魅力值");
	ret &= regist_desc(log_enum::source_type_friend_minus_charm, "减少魅力值");
...
bool source_type_converter_t::regist_equip_desc()
{
	...
	ret &= regist_desc(log_enum::source_type_equip_soul, "装备注灵");
	ret &= regist_desc(log_enum::source_type_equip_add_remake_count, "装备增加改造次数");
...
bool source_type_converter_t::regist_achieve_desc()
{
	...
	ret &= regist_desc(log_enum::source_type_achieve_open_general, "天下大势开启");
...
bool source_type_converter_t::regist_dungeon_desc()
{
	...
	ret &= regist_desc(log_enum::source_type_dungeon_buy, "副本-购买次数");
...
bool source_type_converter_t::regist_role_buff_desc()
{
	...
	ret &= regist_desc(log_enum::source_type_role_buff_king_war, "王城战buff增加");
	ret &= regist_desc(log_enum::source_type_role_buff_server_level, "服务器等级差异增加");
...
bool source_type_converter_t::regist_account_desc()
{
    ...
    ret &= regist_desc(log_enum::source_type_account_play_cg,			"账号-播放CG动画");
    // check size
    uint32_t real_num = m_desc_list.size() - begin_size;
...
bool source_type_converter_t::regist_recharge_desc()
{
	...
	ret &= regist_desc(log_enum::source_type_recharge_cheap, "每日特惠");
...
bool source_type_converter_t::regist_activity_desc()
{
	...
	ret &= regist_desc(log_enum::source_type_activity_ws_rand, "武圣宝库抽奖");
	ret &= regist_desc(log_enum::source_type_activity_ws_score, "武圣宝库宝箱");
...
bool source_type_converter_t::regist_offline_arena_desc()
{
	...
	ret &= regist_desc(log_enum::source_type_offline_arena_score_award, "离线竞技场积分奖励");
...
bool source_type_converter_t::regist_bussiness_act_desc()
{
	...
	ret &= regist_desc(log_enum::source_type_bussiness_buy_month_card, "福利-月卡购买");
	ret &= regist_desc(log_enum::source_type_bussiness_month_card_get_prize, "福利-领取月卡每日奖励");
	ret &= regist_desc(log_enum::source_type_bussiness_level_fund, "福利-等级基金");
	ret &= regist_desc(log_enum::source_type_bussiness_exchang_item, "福利-兑换道具");
	ret &= regist_desc(log_enum::source_type_bussiness_buy_limit, "福利-抢购");
	ret &= regist_desc(log_enum::source_type_bussiness_sevenday_target, "福利-7日目标");
...
bool source_type_converter_t::regist_liandan_desc()
{
	bool ret = true;
	uint32_t begin_size = m_desc_list.size();
	// offline_arena_log
	ret &= regist_desc(log_enum::source_type_liandan_unlock, "炼丹炉槽位解锁");
	ret &= regist_desc(log_enum::source_type_liandan_doing, "炼丹");
	ret &= regist_desc(log_enum::source_type_liandan_done, "立即完成炼丹");
	ret &= regist_desc(log_enum::source_type_liandan_return, "取回丹药");

	// check size
	uint32_t real_num = m_desc_list.size() - begin_size;
	uint32_t should_number = log_enum::source_type_liandan_end - log_enum::source_type_liandan_begin;
	if (real_num != should_number)
	{
		log_error("add liandan desc failed! real_num[%d] didn't equal to should_number[%d]", real_num, should_number);
		return false;
	}
...
bool source_type_converter_t::regist_patrol_hire_desc()
{
	bool ret = true;
	uint32_t begin_size = m_desc_list.size();
	// monster 
	ret &= regist_desc(log_enum::source_type_patrol_point_exchange, "快速巡逻结算");
	ret &= regist_desc(log_enum::source_type_patrol_hire_cal, "雇佣巡逻结算");
	ret &= regist_desc(log_enum::source_type_patrol_hire_client_request, "客户端请求结束雇佣巡逻");
	ret &= regist_desc(log_enum::source_type_patrol_hire_enter_auto_patrol, "进入自动巡逻结束雇佣巡逻");
	ret &= regist_desc(log_enum::source_type_patrol_hire_time_over, "巡逻结束自动结束雇佣巡逻");
	// check size
	uint32_t real_num = m_desc_list.size() - begin_size;
	uint32_t should_number = log_enum::source_type_patrol_hire_end - log_enum::source_type_patrol_hire_begin;
	if (real_num != should_number)
	{
		log_error("add patrol_hire desc failed! real_num[%d] didn't equal to should_number[%d]", real_num, should_number);
		return false;
	}
...
bool source_type_converter_t::regist_general_event_desc()
{
	bool ret = true;
	uint32_t begin_size = m_desc_list.size();
	// monster 
	ret &= regist_desc(log_enum::srouce_type_general_event, "天下大势");
	// check size
	uint32_t real_num = m_desc_list.size() - begin_size;
	uint32_t should_number = log_enum::srouce_type_general_event_end - log_enum::srouce_type_general_event_begin;
	if (real_num != should_number)
	{
		log_error("add patrol_hire desc failed! real_num[%d] didn't equal to should_number[%d]", real_num, should_number);
		return false;
