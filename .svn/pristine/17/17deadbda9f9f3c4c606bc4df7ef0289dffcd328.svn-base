#ifndef __CENTER_GLOBAL_USER_UNIFY_SAVE_HPP__
#define __CENTER_GLOBAL_USER_UNIFY_SAVE_HPP__
...
public:
    ...
    static void add_task(const std::string& key, T msg, bool new_flag = false)
    {
        ...
        {
            //std::pair<map_t<std::string, uint32_t>::type::iterator, bool> ib = m_ki_map.insert(std::make_pair(key, m_idx));
    ...
    static void save()
    {
        ...
        //env::server->send_msg_to_db(op_cmd::ed_batch_save_to_db_notify, m_uid, bstd);
    }
...
private:
    ...
    //static map_t<std::string, uint32_t>::type m_ki_map;
