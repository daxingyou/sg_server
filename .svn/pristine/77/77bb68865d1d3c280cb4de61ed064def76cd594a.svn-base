...
namespace attrtype_enum
{
    enum attr_type
    {
        ...
        vitality				 = 3, // 体质(废弃) 
        spirit					 = 4, // 精神(废弃) 
        additive_damage = 8, // 附加攻击 
        fight_constant = 9, // 战斗常数 
        atk						 = 10, // 攻击力 
        atk_range				 = 11, // 攻击浮动 
        atk_max					 = 12, // 最大攻击 
        def_physical			 = 13, // 防御 
		...
		hp_present_ratio		 = 26, // 当前生命万分比
		hp_loss_ratio			 = 27, // 损失生命万分比
        crit_rate				 = 30, // 暴击 
        crit_damage				 = 31, // 暴击伤害 
        crit_damage_bonus		 = 32, // 暴伤加成 
        crit_damage_reduce		 = 33, // 抗暴 
        ...
        def_physical_reduce = 42, // 破甲效果(防御降低，BUFF用) 
        ...
        luck_points			 = 63, // 气运值 
        luck_shield_points			 = 64, // 气运盾值 
        xiangyu_shield_points			 = 65, // 项羽盾值 
        dodge					 = 70, // 闪避 
        combo_rate				 = 71, // 连击率 
        combo_max				 = 72, // 最大连击数 
        counter_rate			 = 73, // 反击率 
        counter_max				 = 74, // 最大反击数 
		speed_second			 = 75, //第二速度
        ...
        pvp_no_arena_damage		 = 94, // PVP非竞技场增伤 
        ...
        extra_def = 154, // 额外防御 
        extra_hp = 155, // 额外生命 
        be_combo_buffer_id = 156, // 被连击BUFFID 
        temp_terry = 157, // 临时系别 
        extra_skill_ratio = 158, // 技能额外系数 
        crit_add_phase_rate = 159, // 暴击转换段数伤害几率 
        shared_hurt_per = 160, // 分摊百分比 
        reduce_shared_hurt_per = 161, // 减免分摊百分比 
        shared_buff_id = 162, // 分摊英雄 
        buff_round = 163, // 增益回合数变化 
        debuff_round = 164, // 负面回合数变化 
        phase_buffer_id = 165, // 多段连击BUFFID 
		taunt_damage_reduce = 166, // 嘲讽伤害减少  
		dodge_group_target_damage = 167, // 闪避群体攻击伤害 
		speed_effect_reduce_ratio = 168, // 拉条减少万分比
        execute_boss_extra_damage = 169, // 斩杀boss额外伤害万分比 
        stun					 = 200, // 眩晕状态 
        taunt					 = 201, // 嘲讽状态 
        bleeding				 = 202, // 流血状态 
        confused				 = 203, // 混乱状态 
		...
		damage_absorb_and_boom = 223,	//吸收伤害并爆炸
		fairyland				 = 224,	// 幻境状态
        water_immune			 = 300, // 人系免疫 
        fire_immune				 = 301, // 天系免疫 
        wind_immune				 = 302, // 地系免疫 
        		yin_immune				 = 303, // 魔系免疫 
        		yang_immune				 = 304, // 神系免疫 
        water_hurt_reduce = 310, // 受到人系伤害减免 
        fire_hurt_reduce = 311, // 受到天系伤害减免 
        wind_hurt_reduce = 312, // 受到地系伤害减免 
        yin_hurt_reduce = 313, // 受到魔系伤害减免 
        yang_hurt_reduce = 314, // 受到神系伤害减免 
        water_hurt_increase = 315, // 受到人系伤害增加 
        fire_hurt_increase = 316, // 受到天系伤害增加 
        wind_hurt_increase = 317, // 受到地系伤害增加 
        yin_hurt_increase = 318, // 受到魔系伤害增加 
        yang_hurt_increase = 319, // 受到神系伤害增加 
		buff_attacker_be_hurt_count = 320, //buff释放者受攻击次数（用于根据buff释放者受攻击次数来移除buff的buff）
    };
}
//tolua_end
NS_COMMON_END
