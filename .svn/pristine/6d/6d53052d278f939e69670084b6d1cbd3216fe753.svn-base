...
rank_gold_t::rank_gold_t(common::rank_common::rank_type type, const char* name)
	: rank_sort_t(type, name)
{

}

void rank_gold_t::update_rank_from_game(const proto::server::ge_update_rank_notify& notify)
{
