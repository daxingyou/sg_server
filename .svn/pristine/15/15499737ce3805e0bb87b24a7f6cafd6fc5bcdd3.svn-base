...
{
    m_account_msg_handle.register_func(op_cmd::nd_syn_account_info_notify,  handle_nd_syn_account_info_notify);
    m_account_msg_handle.register_func(op_cmd::nd_create_role_reply,        handle_nd_create_role_reply);
	return true;
}

bool account_msg_handler_t::handle_nd_syn_account_info_notify(const network::tcp_socket_ptr& s, const network::msg_buf_ptr& msg_buf)
{
    PRE_S2S_MSG(proto::server::nd_syn_account_info_notify);
