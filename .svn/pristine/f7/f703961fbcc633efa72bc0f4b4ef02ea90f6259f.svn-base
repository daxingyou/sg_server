 ...
 public:
    ...
    void update_to_db(const Connection_T& conn)
    {
        TRY
        {
            ...
            PreparedStatement_setInt(pre,   3, m_task_type);
            PreparedStatement_setInt(pre,	4, m_task_state);
			PreparedStatement_setString(pre,5, m_task_progress.c_str());
            PreparedStatement_setInt(pre,   6, m_accept_time);
