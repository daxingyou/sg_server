...
private:
    ...
    bool m_is_need_save = false;            //数据是否保存
...
public:
    ...
    bool change_pk_mode(proto::common::EM_PK_MODE mode); //改变PK状态
	//进入监狱
	void move_to_prison();
	// 降低PK值定时器触发
...
private:
    ...
    proto::common::EM_PK_MODE m_pk_mode = proto::common::PK_PEACE; //PK模式
...
private:
	uint32_t m_function_code = 0;	//功能代码(初始化 0)
