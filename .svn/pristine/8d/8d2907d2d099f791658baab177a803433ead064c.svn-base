    ...
    void update_to_db(const Connection_T& conn)
    {
        TRY
        {
            ...
            case KICK_ROLE_REASON_GAME_SERVER_CLOSED:
                ...
                break;
			case KICK_ROLE_REASON_CENTER_SERVER_CLOSED:
				source_type = log_enum::source_type_role_logout_center_server_close;
				break;
			case KICK_ROLE_REASON_MSG_BOMB:
				source_type = log_enum::source_type_role_logout_msg_bomb_kick;
				break;
			case KICK_ROLE_REASON_GAME_UNREG:
				source_type = log_enum::source_type_role_logout_game_unreg;
				break;
			...
			case KICK_ROLE_REASON_CROSS_SCENE:
				...
				break;
			case KICK_ROLE_REASON_DB_SERVER_CLOSED:
				source_type = log_enum::source_type_role_logout_db_close;
				break;
            default:
