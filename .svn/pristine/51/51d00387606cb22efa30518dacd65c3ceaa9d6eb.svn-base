...
public:
	...
	void set_challenger_name(const std::string& val) { m_challenger_name = val; }
	const std::string& get_challenger_name() { return m_challenger_name; }
	void set_target_name(const std::string& val) { m_target_name = val; }
