...
{
#ifdef _PLATFORM_X64
	static const int          FormatCheckCode = 0x0C035479; ///< I|IIIIIIIIVVVViIIVIIIIIIII
#else
	static const int          FormatCheckCode = 0x0C1CD219; ///< I|IIIIIIIIvvvviIIvIIIIIIII
#endif
	...
	uint32_t                  wakeup_skill_type;            ///< 觉醒技能类型
	uint32_t                  wakeup_skill_id;              ///< 觉醒技能ID
	uint32_t                  wakeup_skill_replace;         ///< 觉醒替换技能ID
...
struct Hero : public Entry
{
	...
	uint32_t                  wakeup_skill_type()           { return t_wakeup_skill_type; }
	uint32_t                  wakeup_skill_id()             { return t_wakeup_skill_id; }
	uint32_t                  wakeup_skill_replace()        { return t_wakeup_skill_replace; }
...
private:
	...
	uint32_t                  t_wakeup_skill_type;          ///< 觉醒技能类型
	uint32_t                  t_wakeup_skill_id;            ///< 觉醒技能ID
	uint32_t                  t_wakeup_skill_replace;       ///< 觉醒替换技能ID
...
inline void Hero::reset()
{
	...
	this->t_sex = 0;
	this->t_atk_mode = 0;
	this->t_wakeup_skill_type = 0;
	this->t_wakeup_skill_id = 0;
	this->t_wakeup_skill_replace = 0;
...
inline void Hero::fill( const HeroBase& base )
{
	...
	this->t_wakeup_skill_type = base.wakeup_skill_type;
	this->t_wakeup_skill_id = base.wakeup_skill_id;
	this->t_wakeup_skill_replace = base.wakeup_skill_replace;
