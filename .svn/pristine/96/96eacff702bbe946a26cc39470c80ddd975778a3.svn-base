...
public:
	...
	//添加新的统计数据
	static void         set_statistical_data(const uint64_t uid, const proto::common::Achieve_Event_Type type, uint32_t event_id, uint32_t new_value, uint32_t option);

	//测试代码
	static void			test_add_achieve(uint64_t role_uid);
