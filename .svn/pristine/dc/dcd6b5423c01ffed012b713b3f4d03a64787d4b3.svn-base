...
public:
    ...
    static void del_all_roles(uint32_t kick_reason = common::KICK_ROLE_REASON_NONE);
	...
	//目前用于运营活动管理的回调
	static void exec_all_user(void (*func_callback)(role_ptr p_role, uint32_t ex_data), uint32_t ex_data );
public:
