...
bool achieve_msg_handle_t::init_event_handler()
{
	...
	bresult &= m_event_msg_handle.register_func(proto::common::Achieve_Event_Type::ACHIEVE_ARENA_BATTLE_SINGLE_WIN_NUMBER, achieve_common_t::achieve_total_unify_handle);
