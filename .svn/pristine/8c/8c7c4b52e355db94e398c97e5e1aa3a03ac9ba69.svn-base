...
public:
	...
	// 武将更新
	static uint32_t ask_formations_hero_update(const role_ptr& p_role, const proto::client::cg_formations_hero_update_request& request, proto::client::gc_formations_hero_update_reply& reply);
	...
	// 提早结束家族战斗
	static void family_war_early_end(const family_war_scene_ptr& p_war_scene);
