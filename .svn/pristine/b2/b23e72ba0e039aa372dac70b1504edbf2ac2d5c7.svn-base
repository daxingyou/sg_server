...
void active_reward_t::peek_data(proto::common::active_reward_data_single* p_single, bool is_client /* = true */)
{
	...
	ACTIVE_REWARD_LOG("role[%lu] active_reward tid[%d] count[%d] is_finish[%d] is_grant[%d] type[%d] event_id[%d]",m_role_uid,m_tid,m_count,m_is_finish,m_is_grant,m_type,m_event_id);
}


void active_reward_t::save_self(uint64_t role_uid)
{
