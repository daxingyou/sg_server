...
private:
	...
	std::vector<uint32_t>						t_rank_range;                 ///< 排名
	std::map<uint32_t, uint32_t>				t_item;                       ///< 道具奖励
	std::map<uint32_t, uint32_t>				t_day_reward;                 ///< 每日奖励
	std::map<uint32_t, uint32_t>				t_week_reward;                ///< 每周奖励
	std::map<uint32_t, uint32_t>				t_month_reward;               ///< 每月奖励
