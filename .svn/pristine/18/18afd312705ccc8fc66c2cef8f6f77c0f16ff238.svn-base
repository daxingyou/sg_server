...
public:
	...
	static bool handle_cg_formations_hero_up_request(const network::tcp_socket_ptr& s, const network::msg_buf_ptr& msg_buf);
	...
	static bool handle_cg_formations_hero_down_request(const network::tcp_socket_ptr& s, const network::msg_buf_ptr& msg_buf);
