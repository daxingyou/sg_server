...
bool load_config()
{
    ...
    if (NULL != HeroFateManager::getInstancePtr() &&
		!HeroFateManager::getInstancePtr()->loadBinary(env::xml->config_path))
    {
        return false;
    }
    else
    {
        PUSH_TO_CONFIG_LIST("HeroFateManager");
    }

    if (NULL != HeroFateLvManager::getInstancePtr() &&
		!HeroFateLvManager::getInstancePtr()->loadBinary(env::xml->config_path))
    {
        return false;
    }
    else
    {
        PUSH_TO_CONFIG_LIST("HeroFateLvManager");
    }
...
void release_config()
{
    ...
    HeroFateManager::delInstance();
	REMOVE_FROM_CONFIG_LIST("HeroFateManager");

    HeroFateLvManager::delInstance();
	REMOVE_FROM_CONFIG_LIST("HeroFateLvManager");
...
{	
	...
	if (NULL != HeroTalentManager::getInstancePtr() &&
		!HeroTalentManager::getInstancePtr()->loadBinary(env::xml->config_path))
	{
		return false;
	}
	else
	{
		PUSH_TO_CONFIG_LIST("HeroTalentManager");
	}
...
void release_common_config()
{
	...
	HeroTalentManager::delInstance();
	REMOVE_FROM_CONFIG_LIST("HeroTalentManager");
