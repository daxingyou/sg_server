...
struct HeroStar : public Entry
{
	...
	const std::pair<uint32_t, uint32_t>&        consume_material()            { return t_consume_material; }
...
private:
	...
	std::pair<uint32_t, uint32_t>               t_consume_material;           ///< 升星需要材料/数量
...
inline void HeroStar::fill( const HeroStarBase& base )
{
	...
	Dawn::parseTuple(this->t_consume_material, base.consume_material, ":");
