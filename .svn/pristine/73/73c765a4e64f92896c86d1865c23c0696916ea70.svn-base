...
namespace log_enum
{
	enum logs_source_type_t : uint32_t
	{
			...
			source_type_role_add_exp_limit,
			source_type_role_career_award,
			source_type_role_change_name,
			source_type_role_use_item_add_title,
			source_type_role_logout_center_server_close,
			source_type_role_logout_game_unreg,
			source_type_role_logout_db_close,
			source_type_role_use_item_change_plugin,
			source_type_role_office_award,
			source_type_role_use_item_key_gift,
			source_type_role_handbook_award,
			source_type_role_use_item_add_activity,
			...
			source_type_hero_smelt,
			source_type_hero_addfamous,
			...
			source_type_family_levelup_skill,
			...
			source_type_country_demise_king,
			source_type_country_king_war_state,
			source_type_country_king_war_family,
			source_type_country_king_war_failed,
			source_type_country_king_war_end,
			source_type_country_king_war_time_end,
			source_type_country_king_war_help_add,
			source_type_country_king_war_help_del,
			...
			source_type_friend_update_shadow,
			source_type_friend_plus_friendliness,
			source_type_friend_minus_friendliness,
			source_type_friend_send_fp,
			source_type_friend_get_fp,
			source_type_friend_get_relation_award,
			source_type_friend_send_gift,
			source_type_friend_plus_charm,
			source_type_friend_minus_charm,
			...
			source_type_equip_soul,
			source_type_equip_add_remake_count,
			...
			source_type_achieve_open_general,								///开启大势
			...
			source_type_role_buff_king_war,
			source_type_role_buff_server_level,
			...
			source_type_activity_ws_rand,
			source_type_activity_ws_score,
			...
			source_type_offline_arena_score_award,
			source_type_offline_arena_end,

			//炼丹炉
			source_type_liandan_begin = 1800,
			source_type_liandan_unlock = source_type_liandan_begin,
			source_type_liandan_doing,
			source_type_liandan_done,
			source_type_liandan_return,
			source_type_liandan_end,
			...
			source_type_bussiness_month_card_get_prize,
			source_type_bussiness_buy_month_card,
			source_type_bussiness_level_fund,
			source_type_bussiness_exchang_item,
			source_type_bussiness_buy_limit,
			source_type_bussiness_sevenday_target,

			source_type_bussiness_activity_end,


			source_type_patrol_hire_begin = 1950,
			source_type_patrol_point_exchange = source_type_patrol_hire_begin,
			source_type_patrol_hire_cal,
			source_type_patrol_hire_client_request,
			source_type_patrol_hire_enter_auto_patrol,
			source_type_patrol_hire_time_over,
			source_type_patrol_hire_end,


			srouce_type_general_event_begin = 2000,
			srouce_type_general_event = srouce_type_general_event_begin,  
			srouce_type_general_event_end,  
