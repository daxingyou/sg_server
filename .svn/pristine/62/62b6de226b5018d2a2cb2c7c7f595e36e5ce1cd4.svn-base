...
public:
	...
	static bool handle_cg_auto_buy_task_item_request(const network::tcp_socket_ptr& s, const network::msg_buf_ptr& msg_buf );
	static bool handle_eg_destine_item_reply( const network::msg_buf_ptr& msg_buf );
