...
bool king_war_msg_handle_t::init_gate_msg_handler()
{
	...
	bresult &= gate_msg_handler_t::m_gate_msg_handle_from_client.register_func(op_cmd::cg_ask_king_war_fight_request, handle_cg_ask_king_war_fight_request);
	bresult &= gate_msg_handler_t::m_gate_msg_handle_from_client.register_func(op_cmd::cg_king_war_rank_list_request, handle_cg_king_war_rank_list_request);
	bresult &= gate_msg_handler_t::m_gate_msg_handle_from_client.register_func(op_cmd::cg_king_war_jump_request, handle_cg_king_war_jump_request);
...
bool king_war_msg_handle_t::handle_cg_enter_king_war_scene_request(const network::tcp_socket_ptr& s, const network::msg_buf_ptr& msg_buf)
{
	...
	uint32_t reply_code = king_war_manager_t::ask_enter_king_war_scene(p_role, msg.country_id());
...
bool king_war_msg_handle_t::handle_cg_ask_king_war_fight_request(const network::tcp_socket_ptr& s, const network::msg_buf_ptr& msg_buf)
{
	PRE_S2S_MSG(proto::client::cg_ask_king_war_fight_request);
	...
	proto::client::gc_ask_king_war_fight_reply reply;
	king_war_manager_t::ask_king_war_fight(p_role, reply);
	p_role->send_msg_to_client(op_cmd::gc_ask_king_war_fight_reply, reply);

	return true;
}

bool king_war_msg_handle_t::handle_cg_king_war_rank_list_request(const network::tcp_socket_ptr& s, const network::msg_buf_ptr& msg_buf)
{
	PRE_S2S_MSG(proto::client::cg_king_war_rank_list_request);
	...
	proto::client::gc_king_war_rank_list_reply reply;
	king_war_manager_t::ask_king_war_fight_rank(p_role, reply);
	p_role->send_msg_to_client(op_cmd::gc_king_war_rank_list_reply, reply);

	return true;
}

bool king_war_msg_handle_t::handle_cg_king_war_jump_request(const network::tcp_socket_ptr& s, const network::msg_buf_ptr& msg_buf)
{
	PRE_S2S_MSG(proto::client::cg_king_war_jump_request);
	...
	uint32_t back_code = king_war_manager_t::ask_king_war_enter_scene(p_role);
	if (back_code != common::errcode_enum::error_ok) {
		proto::client::gc_king_war_jump_reply reply;
		reply.set_reply_code(back_code);
		p_role->send_msg_to_client(op_cmd::gc_king_war_jump_reply, reply);
	}
